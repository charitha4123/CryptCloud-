...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>File Trace Credintials Requests</span></h2>
          <p>&nbsp;</p>
	...
	int i=0,j=0,k=0;
      	...
      	try 
	{
      		String query="select * from request1"; 
	...
	while ( rs.next() )
	   {
		...
		%>
            ...
            <tr>
              ...
              <td bgcolor="#000000"><div align="center" class="style2"><a href="C_UserSGDetails1.jsp?uname=<%=s2%>"><%=s2%></a></div></td>
              <%	
		...
		%>
              <td bgcolor="#000000"><div class="style30">
                  <div align="center"><a href="A_GrantSearch1.jsp?usid=<%=i%>"><%=s3%></a></div>
              </div></td>
              <%
