...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style27">CryptCloud+: Secure and Expressive Data Access Control for Cloud Storage</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
	...
	while ( rs.next() )
	   {
		...
		%>
            ...
            <tr>
              ...
              <td bgcolor="#000000"><div align="center" class="style29"><a href="C_UserDetails.jsp?name=<%=s2%>"><%=s2%></a></div></td>
              <%	
			if(s5.equalsIgnoreCase("Waiting"))
			{
			
		%>
              <td bgcolor="#000000"><div class="style29">
			...
			{
		%>
              <td width="28" bgcolor="#000000"><div class="style29">
