...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style31">CryptCloud+: Secure and Expressive Data Access Control for Cloud Storage</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
	...
	%>
			...
			while ( rs.next() )
			{
					...
					String dt1 = new String(Base64.decode(s3.getBytes()));
						...
						%>
            <tr>
              <td height="28" bgcolor="#000000" class="style27"><div align="center" class="style32"><%=i%></div></td>
              <td bgcolor="#000000" class="style27"><div align="center" class="style32"><a href="DO_FileDets.jsp?fname=<%=s2%>"><%=s2%></a></div></td>
              <td bgcolor="#000000" class="style27"><div align="center" class="style32"><%=dt1%></div></td>
              <td bgcolor="#000000" class="style27"><div align="center" class="style32"><a href="DO_Delete1.jsp?usid=<%=i%>&fname=<%=s2%>">Delete</a></div></td>
            </tr>
              <%
      ...
      <div class="sidebar">
        <div class="gadget">
         ...
         <ul class="sb_menu">
          ...
          <li><strong><a href="DO_Transactions.jsp">Transactions</a></strong></li>
