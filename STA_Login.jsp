...
<head>
<title>Semi Trusted Authority Login</title>
...
<div class="main">
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="DU_Login.jsp">Semi Trusted Authority </a><a href="about.html"></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Semi Trusted Authority  Login </span></h2>
          <p><img src="images/login.jpg" width="168" height="172" /></p>
          <form action="STA_Authentication.jsp" method="post" id="leavereply">
            <label for="name"><br />
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <li><strong><a href="C_Login.jsp">Cloud</a></strong></li>
          <li><strong><a href="DU_Login.jsp">Data User </a></strong></li>
