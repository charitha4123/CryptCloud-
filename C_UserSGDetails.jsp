...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style1"><span class="style30">CryptCloud+: Secure and Expressive Data Access Control for Cloud Storage</span><br />
        </a></h1>
      </div>
      <div class="menu_nav">
        <ul>
          <li><a href="C_Main.jsp">STA</a></li>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p>&nbsp;</p>
          <p align="right"><a href="STA_GrantSearch.jsp">Back</a></p>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
          ...
          <li><a href="C_ViewFiles.jsp"></a></li>
