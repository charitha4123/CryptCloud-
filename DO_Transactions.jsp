...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style23">CryptCloud+: Secure and Expressive Data Access Control for Cloud Storage</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
	...
	try 
	{
		...
		while ( rs1.next() )
		{
			...
			while ( rs.next() )
			{
				...
				%>
				<tr>
				<td height="29" bgcolor="#000000"><div align="center" class="style25"><%=i%></div></td>
				<td bgcolor="#000000"><div align="center" class="style25"><%=s3%></div></td>
				<td bgcolor="#000000"><div align="center" class="style25"><%=s4%></div></td>
				<td bgcolor="#000000"><div align="center" class="style25"><%=s5%></div></td>
				<td bgcolor="#000000"><div align="center" class="style25"><%=s6%></div></td>
				</tr>
				<%
			}
		}
