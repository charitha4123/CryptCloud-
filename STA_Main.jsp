...
<head>
<title>Semi Trusted Authority  Main</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style2">CryptCloud+: Secure and Expressive Data Access Control for Cloud Storage</a></h1>
      </div>
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="DU_Main.jsp">Semi Trusted Authority </a></li>
      ...
      <div class="sidebar">
       <div class="gadget">
        ...
        <ul class="sb_menu">
		  ...
		  <li><strong><a href="STA_GrantSearch.jsp">Request Search Issue Credintials </a></strong></li>
